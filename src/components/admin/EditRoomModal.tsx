...
const EditRoomModal: React.FC<Props> = ({ roomForm, setRoomForm, onClose, onSubmit }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-xl w-full max-w-md relative p-6 border border-transparent dark:border-neutral-800">
        ...
        <h3 className="text-xl font-bold mb-4 text-blue-600 dark:text-blue-400">Edit Room</h3>
