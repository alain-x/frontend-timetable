...
const TimetableCalendar: FC<TimetableCalendarProps> = ({ setMessage, isAdmin = false, lecturerId, refreshToken }) => {
  ...
  const fetchIntakes = async () => {
    try {
      ...
      const res = await fetch('http://localhost:8091/api/intakes', {
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const endpoint = lecturerId 
        ? `http://localhost:8091/api/lecturer/my-timetables?lecturerId=${lecturerId}`
        : 'http://localhost:8091/api/timetables';
  ...
  const fetchFaculties = async () => {
    try {
      ...
      const res = await fetch('http://localhost:8091/api/faculties', {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchDepartments = async () => {
    try {
      ...
      const res = await fetch('http://localhost:8091/api/departments', {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchCourses = async () => {
    try {
      ...
      const res = await fetch('http://localhost:8091/api/courses', {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchRooms = async () => {
    try {
      ...
      const res = await fetch('http://localhost:8091/api/rooms', {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      (async () => {
        try {
          const res = await fetchWithTimeout('http://localhost:8091/api/timetables', {
            method: 'POST',
            headers: {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      (async () => {
        try {
          const res = await fetchWithTimeout(`http://localhost:8091/api/timetables/${editingEvent.id}`, {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
              Authorization: `Bearer ${token}`,
